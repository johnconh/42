...
/*   Updated: 2022/12/09 18:04:07 by jdasilva         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incs/so_long.h"

void ft_free_c_map(char **c_map, t_point size)
{
	int	i;
...
void ft_checkfloodfill(char **c_map, t_point size, t_game *game)
{
	int	i;
	int	j;
...
void ft_floodfill(char **c_map, t_point size, int x, int y)
{

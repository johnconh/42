...
type LayoutRouteId = RouteId | "/" | "/ftVerify" | "/health-check" | "/local" | "/login" | "/logout" | "/manual" | "/matchmaking" | "/pong" | "/pong/[gameid]" | "/pong2" | "/profile" | "/profile/[user]" | "/pswrd-reset" | "/register" | "/tournament" | "/tournament-local" | "/user-checker" | "/user-settings" | null
type LayoutParams = RouteParams & { gameid?: string; user?: string }
